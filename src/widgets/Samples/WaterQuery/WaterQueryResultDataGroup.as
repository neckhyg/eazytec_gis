...
public class WaterQueryResultDataGroup extends DataGroup
{
    public function WaterQueryResultDataGroup()
    {
        super();

        this.itemRenderer = new ClassFactory(WaterQueryResultItemRenderer);
    }
}
